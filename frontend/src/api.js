// Utilidades de token
export const saveToken  = t  => localStorage.setItem('frosthub_token', t);
export const getToken   = () => localStorage.getItem('frosthub_token');
export const removeToken = () => {
  localStorage.removeItem('frosthub_token');
  localStorage.removeItem('frosthub_user');
};
export const saveUser  = u  => localStorage.setItem('frosthub_user', JSON.stringify(u));
